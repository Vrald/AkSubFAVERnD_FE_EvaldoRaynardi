...
export default function EditProduct() {
    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            if( response.ok ) {
                ...
                alert("Unable to update to the server!")
            }
        }
        catch(error) {
    ...
    return (
        <div className="container my-4">
            <div className="row">
                <div className="col-md-8 mx-auto rounded border border-2 p-4">
...

                    {
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-8">
                                    <input className="form-control" type="number" step="0.01" min="1" name="price" defaultValue={initialData.price}/>
